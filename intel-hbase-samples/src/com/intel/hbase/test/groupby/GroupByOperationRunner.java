package com.intel.hbase.test.groupby;
...
public class GroupByOperationRunner extends Thread {
    ...
    public void run() {
        ...
        try {
            ...
            /*
             * Expression key1 = ExpressionFactory.columnValue("family",
             * "mod10Str"); Expression key2 =
             * ExpressionFactory.columnValue("family", "mod10Str");
             * groupByExpresstions.add(key1); groupByExpresstions.add(key2);
             */
            configGroupByKey(groupByExpresstions, selectExpresstions);

            /*
             * Expression select1 =
             * ExpressionFactory.groupByKey(ExpressionFactory
             * .columnValue("family", "mod10Str")); Expression select2 =
             * ExpressionFactory.count(ExpressionFactory.columnValue("family",
             * "longStr2")); selectExpresstions.add(select1);
